...
app = DjangoDash('q28_static', external_stylesheets=[dbc.themes.BOOTSTRAP])
...
html.Div([
    ...
    html.P("Although we did not find any statistically significant findings for this question, we attribute this difference to our small sample size since many of our results still lined up closely with those of last year’s survey. Our most striking result was that there was still a noticeable difference between the percentage of FGLI versus non-FGLI students who had access to direct connections or referrals across the “close friends and family,” “fellow students,” and “professional networks” categories. It is worth noting however that Harvard OCS is having consistently even results among students of different identities. Additionally, when we compared our results to last year’s results, we noticed that the gender gap seems to have slightly lessened, but there still remains a significant gap when it comes to FGLI vs non-FGLI students.", style = {'font-size': '14pt'})
])
