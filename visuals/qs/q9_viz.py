...
CATEGORIES_MAPPING = {
    'Questions During Lectures':'Q9_1', 'Questions During Sections':'Q9_2', 'Questions During OH':'Q9_3', 'Questions on Online Forum':'Q9_4', 'Questions to TF':'Q9_5'
}
    ...
    html.Div([
        ...
        html.Div([
            dcc.Dropdown(
                ...
                value='Questions During Lectures',
                optionHeight = 70
            )
        ])
