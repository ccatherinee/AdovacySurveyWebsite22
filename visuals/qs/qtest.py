...
import static.dataframe_init as D
...
app = DjangoDash('viztest', external_stylesheets=[dbc.themes.BOOTSTRAP])
...
], style={'width': '20%', 'display': 'inline-table', 'margin-top' : 20, 'margin-left' : 60}),
html.Div([
    html.H4('Filter'),
